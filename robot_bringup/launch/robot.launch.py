...
file_cfg_ekf    = os.path.join(pkg_bringup, 'config', 'robot_localization.yaml')
...
def make_robot_nodes(ns: str, x: str, y: str, z: str, Y: str) -> list:
    ...
    TOPIC_ODOM_GROUND_TRUTH = f'/model/{ns}/pose'
    ...
    # ─────────────────────────────────────────────────────────────────────────
    bridge_args = [
        bridge(TOPIC_IMU, 'sensor_msgs/msg/Imu', 'ignition.msgs.IMU', '['),
        bridge(TOPIC_CMD_VEL, 'geometry_msgs/msg/Twist', 'ignition.msgs.Twist', ']'),
        bridge(TOPIC_JOINTS, 'sensor_msgs/msg/JointState', 'ignition.msgs.Model', '['),
        bridge(TOPIC_LIDAR, 'sensor_msgs/msg/LaserScan', 'ignition.msgs.LaserScan', '['),
        bridge(TOPIC_ODOM_DIFF_DRIVE, 'nav_msgs/msg/Odometry', 'ignition.msgs.Odometry', '['),
        bridge(TOPIC_ODOM_PUBLISHER, 'nav_msgs/msg/Odometry', 'ignition.msgs.Odometry', '['),
        bridge(TOPIC_ODOM_GROUND_TRUTH, 'geometry_msgs/msg/PoseStamped', 'ignition.msgs.Pose', '['),

        bridge(TOPIC_TF_DIFF_DRIVE, 'tf2_msgs/msg/TFMessage', 'ignition.msgs.Pose_V', '['),
        bridge(TOPIC_TF_ODOM_PUBLISHER, 'tf2_msgs/msg/TFMessage', 'ignition.msgs.Pose_V', '['),
    
        # bridge(TOPIC_IMAGE_COLOR, 'sensor_msgs/msg/Image', 'ignition.msgs.Image', '['),
        # bridge(TOPIC_IMAGE_DEPTH, 'sensor_msgs/msg/Image', 'ignition.msgs.Image', '['),
        # bridge(TOPIC_CAMERA_INFO, 'sensor_msgs/msg/CameraInfo', 'ignition.msgs.CameraInfo', '['),
        # bridge(TOPIC_CAMERA_POINTS, 'sensor_msgs/msg/PointCloud2', 'ignition.msgs.PointCloudPacked','['),
    ]
    ...
    remappings=[
        ...
        (TOPIC_ODOM_PUBLISHER, f'/{ns}/odom/odom_publisher'),
        (TOPIC_ODOM_DIFF_DRIVE, f'/{ns}/odom/diff_drive'),
        (TOPIC_ODOM_GROUND_TRUTH, f'/{ns}/odom/ground_truth'),
    ...
    return [run_robot, run_rsp, run_bridge, run_ekf]
